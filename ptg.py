...
def PTG(start_s, start_d, target_vehicle, delta, T, predictions):
    ...
    for goal in all_goals:
        ...
        # print("s_coefficients: ", s_coefficients)
        d_coefficients = JMT(start_d, d_goal, t)
        # print("d_coefficients: ", d_coefficients)
...
def perturb_goal(goal_s, goal_d):
    ...
    Random points around the calculated goal state behind a target
    """
    new_s_goal = []
    # print("S")
    # avg, std dev
